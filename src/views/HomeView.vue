  ...
  <div>
    ...
    <div class="wrap" style="padding-top: 30px">
      <div class="panel ticks" style="display: flex; align-items: stretch">
        ...
        <div style="padding: 30px 32px; flex: 1; min-width: 0">
          <div class="dim mono-xs upper" style="margin-bottom: 14px">
        ...
        >
          <HeroImage />
          <div class="dim mono-xs" style="text-align: center; letter-spacing: 0.18em">
            // MASK ON
          </div>
        </div>
      </div>
    ...
    <div class="wrap">
      ...
      >
        ...
        <span class="tag btn" @click="router.push('/archive')"
          >view all ({{ ARTICLES.length }}) ▸</span
        >
      </div>
      ...
      <div class="bull-grid">
        <!-- big tile (pinned) -->
        <a
          class="tile tile-pinned"
          style="grid-row: span 2; justify-content: space-between; padding: 22px 24px"
        ...
        >
          ...
          <div style="position: relative; z-index: 1; margin-top: 18px">
            ...
            <p class="fg2" style="margin-top: 18px; max-width: 380px; font-size: 13.5px">
              {{ pinned.dek }}
            </p>
          </div>
          <div
          ...
          >
            ...
            <span class="tile-go upper" style="font-size: 12px; letter-spacing: 0.08em"
              >read ▸</span
            >
          </div>
        </a>
        ...
        >
          ...
          >
            ...
            <span class="tile-go upper" style="font-size: 11px; letter-spacing: 0.08em"
              >open ▸</span
            >
          </div>
        </a>
...
last sync .. 2026.06.01</pre
      ...
      <div class="dim mono-xs" style="margin-top: 26px; text-align: center; letter-spacing: 0.14em">
